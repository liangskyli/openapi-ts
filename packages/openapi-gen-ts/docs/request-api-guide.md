...
export interface IApi {
    ...
    '/root/getQueryParams1-v4': {
        Query: paths['/root/getQueryParams1-v4']['get']['parameters']['query'];
        Response: paths['/root/getQueryParams1-v4']['get']['responses']['200']['content']['text/plain'];
    };
    '/root/postBody1-v4': {
        Query: paths['/root/postBody1-v4']['post']['parameters']['query'];
        Body: paths['/root/postBody1-v4']['post']['requestBody']['content']['text/plain'];
        Response: paths['/root/postBody1-v4']['post']['responses']['200']['content']['text/plain'];
    };
}
```
...
export const requestApi = {
    '/root/v1/getQueryParams1': <T extends Record<any, any> = {}>(
        config: IConfig<
    ...
    '/root/v1/getQueryParam': <T extends Record<any, any> = {}>(
        config: IConfig<
            Omit<T & AxiosRequestConfig, 'method' | 'url' | 'params'>,
            {
    ...
    '/root/v1/getQueryParamWithQueryParams': <T extends Record<any, any> = {}>(
        config: IConfig<
            Omit<T & AxiosRequestConfig, 'method' | 'url' | 'params'>,
            {
    ...
    '/root/v1/getParam': <T extends Record<any, any> = {}>(
        config: IConfig<Omit<T & AxiosRequestConfig, 'method' | 'url'>, {}>,
    ...
    '/root/v1/getQueryParamWithParam': <T extends Record<any, any> = {}>(
        config: IConfig<
            Omit<T & AxiosRequestConfig, 'method' | 'url' | 'params'>,
            {
    ...
    '/root/v1/postBody1': <T extends Record<any, any> = {}>(
        config: IConfig<
    ...
    '/root/v1/postBody2': <T extends Record<any, any> = {}>(
        config: IConfig<
    ...
    '/root/v1/postBody3': <T extends Record<any, any> = {}>(
        config: IConfig<
            Omit<T & AxiosRequestConfig, 'method' | 'url' | 'data'>,
            {
    ...
    '/root/v1/postBody4': <T extends Record<any, any> = {}>(
        config: IConfig<
            Omit<T & AxiosRequestConfig, 'method' | 'url' | 'data'>,
            {
    ...
    '/root/v1/postBodyParam': <T extends Record<any, any> = {}>(
        config: IConfig<
            Omit<T & AxiosRequestConfig, 'method' | 'url' | 'data'>,
            {
    ...
    '/root/v2/getQueryParams1-v2': <T extends Record<any, any> = {}>(
        config: IConfig<
            Omit<T & AxiosRequestConfig, 'method' | 'url' | 'params'>,
            {
    ...
    '/root/v2/getQueryParam-v2/{id}': <T extends Record<any, any> = {}>(
        config: IConfig<
            Omit<T & AxiosRequestConfig, 'method' | 'url' | 'params'>,
            {
    ...
    '/root/getQueryParams1-v3': <T extends Record<any, any> = {}>(
        config: IConfig<
            Omit<T & AxiosRequestConfig, 'method' | 'url' | 'params'>,
            {
    ...
    '/root/getQueryParam-v3/{id}': <T extends Record<any, any> = {}>(
        config: IConfig<
            Omit<T & AxiosRequestConfig, 'method' | 'url' | 'params'>,
            {
    ...
    '/root/postBody1-v3': <T extends Record<any, any> = {}>(
        config: IConfig<
            Omit<T & AxiosRequestConfig, 'method' | 'url' | 'data'>,
            {
    ...
    '/root/getQueryParams1-v4': <T extends Record<any, any> = {}>(
        config: IConfig<
            Omit<T & AxiosRequestConfig, 'method' | 'url' | 'params'>,
            {
                params: IApi['/root/getQueryParams1-v4']['Query'];
            }
            >,
    ): Promise<IApi['/root/getQueryParams1-v4']['Response']> => {
        const { params, ...otherConfig } = config;

        return request({
            method: 'GET',
            url: '/root/getQueryParams1-v4',
            params: params,

            ...otherConfig,
        });
    },
    '/root/postBody1-v4': <T extends Record<any, any> = {}>(
        config: IConfig<
            Omit<T & AxiosRequestConfig, 'method' | 'url' | 'params' | 'data'>,
            {
                params: IApi['/root/postBody1-v4']['Query'];
                data: IApi['/root/postBody1-v4']['Body'];
            }
            >,
    ): Promise<IApi['/root/postBody1-v4']['Response']> => {
        const { params, data, ...otherConfig } = config;

        return request({
            method: 'POST',
            url: '/root/postBody1-v4',
            params: params,
            data: data,
            ...otherConfig,
        });
...
requestApi['/root/v1/postBody2']({data:{param1:'1'}}).then((res)=>{
  console.log(res);
});
